...
|---------|--------|-------|-------------|
| **Victor** | @Vctor11180 | [#10](https://github.com/Kenyi001/oraculo-radiohead/issues/10) | **Redeploy Base Sepolia** (Eth Sepolia no cuenta) — ver comentario en #10 |
...
| `rama-victor` | Eth Sepolia incorrecto — **no mergear**; redeploy desde master a Base |

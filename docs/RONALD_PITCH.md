# Ronald — pitch listo para grabar (≤3 min)
...
## Guion hablado ES (verbatim, ~2:40)

*(Cronómetro. Pausá en los puntos. No apures.)*
...
Acá está tu wallet: quinientos USDT. Auto-custodia — no es de Casandra.  
...
Ahora el agente intenta gastar por WDK.  
Click… **BLOCKED**. La plata no se mueve con un claim falso.  
Dry-run con `@tetherto/wdk` — sin broadcast en vivo.

**2:20–2:40 — Vs WWall + tracks**  
WWall pone políticas de wallet — límites, allowlists.  
Casandra cierra la puerta cuando el **claim es mentira**. Complementamos; no competimos por el mismo ángulo.  
Tracks: **General** + **WDK Track 1**.

**2:40–3:00 — Cierre**  
Hash anclable en Ethereum Sepolia. Repo y demo en la descripción.  
No es consejo financiero.  
Casandra: pueden hablar. No pueden sellar una mentira.

---

## English spoken (si grabás en EN)
...
## Líneas anti-genéricas (vs WWall / peers)

Decí **una** de estas (no todas):

- “WWall pregunta *¿podés gastar?* Nosotros preguntamos *¿es verdad lo que dijo el agente?*”
- “No custodiamos USDT. Solo abrimos o cerramos la puerta.”
- “No es otro oracle de precios: es un sello de contradicción + gate WDK.”
- “Hallucinated txs y MCP send abuse: el claim falso no pasa.”

**Nunca digas:** “somos como un wallet policy MCP”, “WDK es opcional”, “Market Pulse first”.

---

## Shot list (cámara / pantalla)
...
## Datos de juez (por si preguntan)
